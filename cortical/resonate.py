...
# Make the model
dummy_model = DummyEncoder(grid=grid, input_img=orig_img, input_chans=3, output_chans=3).to(device)
...
# Optimizer params
optimizer = optim.AdamW(params_to_learn, lr=0.001, betas=(0.9, 0.999), eps=1e-08, weight_decay=0.01, amsgrad=False)
