...
midpoint_y = grid.shape[0]//3
midpoint_x = grid.shape[1]//4
...
#
grid[midpoint_y-20:midpoint_y+20, midpoint_x-20:midpoint_x+20, 0] = fdtd.AnisotropicObject(permittivity=250000000000000000.0, name="object")
grid[midpoint_y-4:midpoint_y+4, midpoint_x-4:midpoint_x+4, 0:1] = fdtd.PlaneSource(
    period=WAVELENGTH / SPEED_LIGHT, name="linesource4", polarization = 'x'
)
# ## Run simulation
